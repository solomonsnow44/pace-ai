-- Add an org-admin controlled test account visibility flag.
...
drop function if exists public.update_admin_settings(uuid, boolean, boolean);
...
grant all on function public.update_admin_settings(uuid, boolean, boolean, boolean) to anon, authenticated, service_role;
